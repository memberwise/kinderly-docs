...
description: Which settings page does what — there are two, and they're easy to confuse.
sidebar:
  order: 2
---

Kinderly has two settings areas. Knowing which is which saves a lot of hunting.

## Settings — your account

Reached from the icon rail. Covers **you and your subscription**:

- **Profile** — your name, email, password reset
- **Payment & Billing** — your Kinderly plan, payment methods, invoices, usage
- **Teams** — your team, its members, creating another team
...
- **Immunizations** — the immunisation list
- **Custom Fields** — extra fields on the child record
- **Class Ratios** — required staff-to-child ratios
- **Billing** — family billing configuration
- **App Settings** — what families and staff see in the mobile apps
- **Setup Wizard** — walk back through the basics

See [Manage settings](/manage/settings/).
