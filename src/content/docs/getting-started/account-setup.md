...
Everything here lives under **Settings**, reachable from the icon rail on the left.
...
:::tip[Invite people properly rather than sharing one login]
It's tempting to have one shared account "for the office". Don't. Individual logins mean the audit trail actually tells you who sent what, and removing a departing staff member's access is one click rather than a password change everybody has to learn.
:::
...
**Payment & Billing** covers your subscription, plan tier, payment methods and invoices.

![The Payment & Billing section showing plan tiers and saved payment methods](../../../assets/screenshots/settings-plans.png)

- **Add Card** stores a payment method. One is marked **Default**.
- **View Invoices** shows your billing history.
- **Usage** shows consumption against your plan's limits.

See [Billing & subscriptions](/billing/overview/).

:::caution[Keep a current card on file]
...
**Danger Zone** at the bottom permanently deletes your account and everything in it.

:::caution[This cannot be undone]
Deleting removes children's records, submitted documents and signed forms. If you have any retention obligation for enrollment records, export what you need first — a deleted account can't be recovered.
:::
